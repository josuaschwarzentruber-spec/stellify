...
<body>
  ...
  const translations: Record<string, any> = {
    DE: {
      ...
      onboarding_tools_desc: "Der Bewerbungs-Generator erstellt deine komplette Bewerbung als PDF und Word. Die Bewerbungs-Strategie plant deinen nächsten Schritt.",
    ...
    FR: {
      ...
      onboarding_tools_desc: "Le Générateur de candidatures crée ta candidature complète en PDF et Word. La Stratégie de candidature planifie ton prochain pas.",
    ...
    IT: {
      ...
      onboarding_tools_desc: "Il Generatore di candidature crea la tua candidatura completa in PDF e Word. La Strategia di candidatura pianifica il tuo prossimo passo.",
    ...
    EN: {
      ...
      onboarding_tools_desc: "The Application Generator creates your full application as PDF and Word. The Application Strategy plans your next move.",
