...
<body>
  ...
  const translations: Record<string, any> = {
    DE: {
      ...
      auth_terms_and: "und",
      auth_terms_data_processing: "Deine Daten werden nach Schweizer Datenschutzrecht (DSG) und DSGVO verarbeitet.",
      ...
      security_item_1_t: "Schweizer Datenschutz",
      security_item_1_d: "Verarbeitung nach Schweizer Datenschutzgesetz (DSG) und DSGVO durch sorgfältig geprüfte Anbieter, verschlüsselt übertragen.",
    ...
    FR: {
      ...
      auth_terms_and: "et",
      auth_terms_data_processing: "Tes données sont traitées selon le droit suisse (LPD) et le RGPD.",
      ...
      security_item_1_t: "Protection des données suisse",
      security_item_1_d: "Traitement selon le droit suisse (LPD) et le RGPD par des prestataires soigneusement sélectionnés, transmission chiffrée.",
    ...
    IT: {
      ...
      auth_terms_and: "e",
      auth_terms_data_processing: "I tuoi dati sono trattati secondo il diritto svizzero (LPD) e il GDPR.",
      ...
      security_item_1_t: "Protezione dati svizzera",
      security_item_1_d: "Trattamento secondo il diritto svizzero (LPD) e il GDPR da parte di fornitori accuratamente selezionati, trasmissione crittografata.",
    ...
    EN: {
      ...
      auth_terms_and: "and",
      auth_terms_data_processing: "Your data is processed under Swiss data-protection law (FADP) and the GDPR.",
      ...
      security_item_1_t: "Swiss data protection",
      security_item_1_d: "Processed under Swiss data-protection law (FADP) and the GDPR by carefully vetted providers, transmitted encrypted.",
          ...
          >
            ...
            <div className="flex flex-col gap-5 w-full max-w-md">
              ...
              <p className="-mt-2 text-[11px] text-[#6B6B66] dark:text-[#9A9A94] font-light">
                {language === 'FR' ? "Optionnel : ça marche aussi sans CV et sans lien d'annonce, tu peux tout saisir manuellement."
                  : language === 'IT' ? "Facoltativo: funziona anche senza CV e senza link dell'annuncio, puoi inserire tutto manualmente."
                  : language === 'EN' ? 'Optional: it also works without a CV and without a job link, you can enter everything manually.'
                  : 'Optional: geht auch ganz ohne Lebenslauf und ohne Inserat-Link, du kannst alles auch manuell eingeben.'}
              </p>
