                    ...
                    {isInAppBrowser() && (
                      <div className="flex items-start gap-2.5 p-3 bg-[#004225]/6 dark:bg-[#00A854]/10 border border-[#004225]/20 dark:border-[#00A854]/25">
                        ...
                        <p className="text-[11px] text-[#4A4A45] dark:text-[#B5B5AF] font-light leading-relaxed">
                          {language === 'FR' ? "Tu as ouvert cette page depuis une autre app, par exemple Instagram ou la recherche Google. Dans cette petite fenêtre, le bouton Google est bloqué par Google, par sécurité. Le plus simple: inscris-toi ici par e-mail, ça marche parfaitement. Ou ouvre stellify.ch dans ton navigateur habituel."
                            : language === 'IT' ? "Hai aperto questa pagina da un'altra app, per esempio Instagram o la ricerca Google. In questa piccola finestra il pulsante Google è bloccato da Google, per sicurezza. La via più semplice: registrati qui via e-mail, funziona perfettamente. Oppure apri stellify.ch nel tuo browser abituale."
                            : language === 'EN' ? 'You opened this page from another app, for example Instagram or Google Search. In this small window, the Google button is blocked by Google itself, for security. Easiest fix: sign up right here with your email, it works perfectly. Or open stellify.ch in your usual browser.'
                            : 'Du hast diese Seite über eine andere App geöffnet, zum Beispiel über Instagram oder die Google-Suche. In diesem kleinen Fenster blockiert Google die Anmeldung per Google-Knopf, aus Sicherheitsgründen. Am einfachsten: Registriere dich gleich hier per E-Mail, das klappt einwandfrei. Oder öffne stellify.ch in deinem normalen Browser.'}
                        </p>
                      </div>
                    )}
