...
const STR: Record<string, Record<string, string>> = {
  DE: {
    ...
    use_cv_label: 'Meinen hochgeladenen Lebenslauf verwenden', use_cv_hint: 'Stella nutzt deinen Lebenslauf für Erfahrung, Ausbildung und Skills.', no_cv_hint: 'Der Lebenslauf ist optional. Mit ihm wird die Bewerbung noch besser, aber du kannst die Felder auch einfach von Hand ausfüllen.',
    badge_new: 'Neu',
  ...
  FR: {
    ...
    use_cv_label: 'Utiliser mon CV téléchargé', use_cv_hint: 'Stella utilise ton CV pour expérience, formation et compétences.', no_cv_hint: 'Le CV est optionnel. Il rend la candidature encore meilleure, mais tu peux aussi remplir les champs à la main.',
    badge_new: 'Nouveau',
  ...
  IT: {
    ...
    use_cv_label: 'Usa il mio CV caricato', use_cv_hint: 'Stella usa il tuo CV per esperienza, formazione e competenze.', no_cv_hint: 'Il CV è facoltativo. Rende la candidatura ancora migliore, ma puoi anche compilare i campi a mano.',
    badge_new: 'Nuovo',
  ...
  EN: {
    ...
    use_cv_label: 'Use my uploaded CV', use_cv_hint: 'Stella uses your CV for experience, education and skills.', no_cv_hint: 'The CV is optional. It makes the application even better, but you can also just fill in the fields by hand.',
    badge_new: 'New',
...
const ApplicationGenerator = ({ language, user, profile, cvContext, locked, onUpgrade, showToast, authFetch, onUploadCv, recordUsage, usage, initialTarget, initialDocId, onAddToTracker }: {
  ...
  cvContext?: string;
  locked: boolean;
  onUpgrade: (reason?: 'quota' | 'daily' | 'feature', message?: string) => void;
