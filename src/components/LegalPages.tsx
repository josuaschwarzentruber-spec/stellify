          ...
          <article>
            ...
            {isDE ? <>
              <Section title="1. Verantwortliche Person">
                ...
                <div className="mt-3 p-4 bg-[#F5F4F0] dark:bg-[#2A2A26] font-mono text-xs space-y-1"><p>Stellify</p><p>Inhaber: JTSP</p><p>Postfach</p><p>Luzern, Schweiz</p><p>E-Mail: support.stellify@gmail.com</p></div>
              </Section>
              ...
              <Section title="5. Weitergabe an Dritte">
                ...
                <ProviderDetails summary="Liste der Dienstleister anzeigen" providers={[['Authentifizierungsdienst (Google LLC)', 'Zweck: Authentifizierung, Datenbankhosting. Sitz: USA. Schutzinstrument: EU-Standardvertragsklauseln (SCCs).'],['KI-Dienst (DeepSeek / Hangzhou DeepSeek AI Co., Ltd.)', 'Zweck: Stellify erstellt deine Bewerbungstexte mit dieser KI und verbessert damit laufend die Qualität. Zu diesem Zweck können übermittelte Eingaben zur Verbesserung und zum Training der KI-Modelle verwendet werden; in der Regel wird dafür nur ein kleiner Teil der Eingaben genutzt. Übermittelt werden die für die Erstellung nötigen Inhalte, einschliesslich deines Lebenslauf-Textes und deiner Angaben; keine Kontozugangs- oder Zahlungsdaten. Sitz: China (kein Angemessenheitsbeschluss der Schweiz/EU). Rechtsgrundlage der Übermittlung ist deine ausdrückliche Einwilligung, die du bei der Registrierung erteilst (Art. 17 Abs. 1 lit. a DSG / Art. 49 Abs. 1 lit. a DSGVO).'],['Stripe Inc.', 'Zweck: Zahlungsabwicklung. Sitz: USA. Stripe ist PCI-DSS-zertifiziert.'],['Cloud-Hosting-Anbieter (Vercel Inc.)', 'Zweck: Hosting der Web-Applikation. Sitz: USA. Schutzinstrument: EU-Standardvertragsklauseln.']]} />
              </Section>
              ...
              <Section title="1. Responsable du traitement">
                ...
                <div className="mt-3 p-4 bg-[#F5F4F0] dark:bg-[#2A2A26] font-mono text-xs space-y-1"><p>Stellify</p><p>Titulaire : JTSP</p><p>Case postale</p><p>Lucerne, Suisse</p><p>E-mail : support.stellify@gmail.com</p></div>
              </Section>
              ...
              <Section title="5. Transfert à des tiers">
                ...
                <ProviderDetails summary="Afficher la liste des prestataires" providers={[['Service d\'authentification (Google LLC)', 'Finalité : authentification, hébergement de base de données. Siège : USA. Protection : clauses contractuelles types UE (CCT).'],['Service IA (DeepSeek / Hangzhou DeepSeek AI Co., Ltd.)', 'Finalité : Stellify crée tes textes de candidature avec cette IA et en améliore ainsi continuellement la qualité. À cette fin, les entrées transmises peuvent être utilisées pour améliorer et entraîner les modèles d\'IA; en règle générale, seule une petite partie des entrées est utilisée. Sont transmis les contenus nécessaires à la création, y compris le texte de ton CV et tes informations; aucune donnée d\'accès au compte ni de paiement. Siège : Chine (pas de décision d\'adéquation). La base légale du transfert est ton consentement explicite, donné lors de l\'inscription (art. 17 al. 1 lit. a LPD / art. 49 al. 1 lit. a RGPD).'],['Stripe Inc.', 'Finalité : traitement des paiements. Siège : USA. Stripe est certifié PCI-DSS.'],['Hébergeur cloud (Vercel Inc.)', 'Finalité : hébergement de l\'application web. Siège : USA. Protection : clauses contractuelles types UE.']]} />
              </Section>
              ...
              <Section title="1. Titolare del trattamento">
                ...
                <div className="mt-3 p-4 bg-[#F5F4F0] dark:bg-[#2A2A26] font-mono text-xs space-y-1"><p>Stellify</p><p>Titolare: JTSP</p><p>Casella postale</p><p>Lucerna, Svizzera</p><p>E-mail: support.stellify@gmail.com</p></div>
              </Section>
              ...
              <Section title="5. Trasferimento a terzi">
                ...
                <ProviderDetails summary="Mostra l'elenco dei fornitori" providers={[['Servizio di autenticazione (Google LLC)', 'Finalità: autenticazione, hosting database. Sede: USA. Strumento di protezione: clausole contrattuali tipo UE (SCC).'],['Servizio IA (DeepSeek / Hangzhou DeepSeek AI Co., Ltd.)', 'Finalità: Stellify crea i tuoi testi di candidatura con questa IA e ne migliora così costantemente la qualità. A tale scopo, gli input trasmessi possono essere usati per migliorare e addestrare i modelli di IA; di norma viene utilizzata solo una piccola parte degli input. Vengono trasmessi i contenuti necessari alla creazione, incluso il testo del tuo CV e i tuoi dati; nessun dato di accesso al conto né di pagamento. Sede: Cina (nessuna decisione di adeguatezza). La base giuridica del trasferimento è il tuo consenso esplicito, fornito al momento della registrazione (art. 17 cpv. 1 lett. a LPD / art. 49 cpv. 1 lett. a GDPR).'],['Stripe Inc.', 'Finalità: elaborazione pagamenti. Sede: USA. Stripe è certificato PCI-DSS.'],['Provider hosting cloud (Vercel Inc.)', 'Finalità: hosting dell\'applicazione web. Sede: USA. Strumento: clausole contrattuali tipo UE.']]} />
              </Section>
              ...
              <Section title="1. Data Controller">
                ...
                <div className="mt-3 p-4 bg-[#F5F4F0] dark:bg-[#2A2A26] font-mono text-xs space-y-1"><p>Stellify</p><p>Owner: JTSP</p><p>P.O. Box</p><p>Lucerne, Switzerland</p><p>Email: support.stellify@gmail.com</p></div>
              </Section>
              ...
              <Section title="5. Third-Party Data Sharing">
                ...
                <ProviderDetails summary="Show the list of providers" providers={[['Authentication Service (Google LLC)', 'Purpose: Authentication, database hosting. Location: USA. Safeguard: EU Standard Contractual Clauses (SCCs).'],['AI Service (DeepSeek / Hangzhou DeepSeek AI Co., Ltd.)', 'Purpose: Stellify creates your application texts with this AI and continuously improves their quality. For this purpose, transmitted inputs may be used to improve and train the AI models; as a rule, only a small part of the inputs is used. The content required for the creation is transmitted, including your CV text and your details; no account login or payment data. Location: China (no adequacy decision). The legal basis for the transfer is your explicit consent, given at registration (Art. 17(1)(a) FADP / Art. 49(1)(a) GDPR).'],['Stripe Inc.', 'Purpose: Payment processing. Location: USA. Stripe is PCI-DSS certified.'],['Cloud Hosting Provider (Vercel Inc.)', 'Purpose: Web application hosting. Location: USA. Safeguard: EU Standard Contractual Clauses.']]} />
              </Section>
          ...
          <article>
            ...
            <Section title={isDE ? 'Betreiber und Verantwortlicher' : isFR ? 'Exploitant et responsable' : isIT ? 'Gestore e responsabile' : 'Operator & Controller'}>
              <div className="p-5 bg-[#F5F4F0] dark:bg-[#2A2A26] space-y-2 font-mono text-xs">
                ...
                <p>{isDE ? 'Inhaber: JTSP' : isFR ? 'Titulaire : JTSP' : isIT ? 'Titolare: JTSP' : 'Owner: JTSP'}</p>
                <p>{isDE ? 'Postfach' : isFR ? 'Case postale' : isIT ? 'Casella postale' : 'P.O. Box'}</p>
                <p>{isDE ? 'Luzern, Schweiz' : isFR ? 'Lucerne, Suisse' : isIT ? 'Lucerna, Svizzera' : 'Lucerne, Switzerland'}</p>
              </div>
            </Section>
          ...
          <article>
            ...
            {isDE ? <>
              ...
              <Section title="9a. KI-Inhalte und Eigenverantwortung">
                <p>Stellify nutzt ein grosses Sprachmodell (KI) eines Drittanbieters (DeepSeek). Generierte Inhalte sind statistische Wahrscheinlichkeitsausgaben und können unvollständig, sachlich falsch, veraltet oder vollständig erfunden sein.</p>
              ...
              <Section title="9a. Contenus IA et responsabilité de l'utilisateur">
                <p>Stellify utilise un grand modèle de langage (IA) d'un tiers (DeepSeek). Les contenus générés sont des sorties probabilistes statistiques et peuvent être incomplets, factuellement incorrects, obsolètes ou entièrement inventés.</p>
              ...
              <Section title="9a. Contenuti IA e responsabilità dell'utente">
                <p>Stellify utilizza un grande modello linguistico (IA) di terze parti (DeepSeek). I contenuti generati sono output probabilistici statistici e possono essere incompleti, fattualmente errati, obsoleti o interamente inventati.</p>
              ...
              <Section title="9a. AI Content and User Responsibility">
                <p>Stellify uses a third-party large language model (AI), DeepSeek. Generated content consists of statistical probability outputs and may be incomplete, factually incorrect, outdated or entirely fabricated.</p>
